...
void LogicSystem::RegisterCallBacks()
{
    ...
    fun_callbacks_[ID_LOAD_CHAT_MSG_REQ] = std::bind(&LogicSystem::LoadChatMsg,
        this,
        placeholders::_1,
        placeholders::_2,
        placeholders::_3);
    ...
    SessionPtr session, const short& msg_id, const string& msg_data)
{
    ...
    LOG_INFO(
        "user add friend apply, uid: {}, applydesc: {}, touid: {}, bakname: {}",
        uid, desc, touid, bakname);
    ...
    add_req.set_name(apply_info->name_);
...
void LogicSystem::LoadChatMsg(std::shared_ptr<Session> session,
